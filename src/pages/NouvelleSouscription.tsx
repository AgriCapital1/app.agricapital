    ...
    try {
      ...
      const { data: souscripteur, error: errorSous } = await (supabase as any)
        ...
        .insert({
          ...
          conjoint_nom_prenoms: `${formData.cotit_nom_famille} ${formData.cotit_prenoms}`,
          conjoint_type_piece: formData.cotit_type_piece,
          conjoint_numero_piece: formData.cotit_numero_piece,
          conjoint_date_delivrance: formData.cotit_date_delivrance,
          conjoint_telephone: formData.cotit_telephone,
          conjoint_whatsapp: formData.cotit_whatsapp,
          conjoint_photo_identite_url: formData.cotit_photo_cni || "",
          conjoint_photo_url: formData.cotit_photo_profil || "",
          ...
          banque_operateur: formData.banque_operateur,
          created_by: user.id,
        })
        .select()
        .single();
